...
class App extends Component {
  ...
  addMovie=(newimage,newfilm,newrate)=>{this.setState({filmlist:this.state.filmlist.concat({film:newfilm,image:newimage,rating:newrate})})}
  ...
  return (
    <div>
     ...
     <div className="rating-filter">
      ...
      <Films x={this.state.filmlist.filter(el=>el.rating>=this.state.rate && el.film.toLowerCase().includes(this.state.search.trim().toLowerCase()))}/>
